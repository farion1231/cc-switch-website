...
![The Needs Routing marker on a GPT provider in the Claude provider list](/docs/assets/claude-codex-routing/01-claude-providers-require-routing.png)
...
![Method 1: in Advanced Options, set API Format to OpenAI Responses, keep the default auth field, and map to the upstream's real models](/docs/assets/claude-codex-routing/02-responses-provider-form.png)
...
![Method 2: ChatGPT login status and account management in the Codex preset](/docs/assets/claude-codex-routing/03-codex-oauth-form.png)
...
- [CC Switch User Manual: Add a Provider (incl. Codex OAuth reverse proxy and API formats)](/en/docs?section=providers&item=add)
...
- [CC Switch v3.17.0 Release Notes](/en/changelog/3.17.0)
- Reverse guide: [Using Claude Models in Codex](/en/tutorials/codex-claude-routing-guide)
