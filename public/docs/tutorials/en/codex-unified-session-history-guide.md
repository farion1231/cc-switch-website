...
- [Keep Codex Remote Control and Official Plugins While Using Third-Party APIs: CC Switch Setup Guide](/en/tutorials/codex-official-auth-preservation-guide)
- [Using DeepSeek-Style Chat APIs in Codex: CC Switch Local Routing Guide](/en/tutorials/codex-deepseek-routing-guide)
