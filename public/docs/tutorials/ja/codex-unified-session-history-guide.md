...
- [サードパーティ API 利用時に Codex のリモート操作と公式プラグインを保持する: CC Switch 設定ガイド](/ja/tutorials/codex-official-auth-preservation-guide)
- [Codex で DeepSeek などの Chat 形式 API を使う: CC Switch ローカルルーティングガイド](/ja/tutorials/codex-deepseek-routing-guide)
