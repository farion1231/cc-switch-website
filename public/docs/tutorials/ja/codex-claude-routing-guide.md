...
![Codex プロバイダー一覧の「ルーティングが必要」マーク](/docs/assets/codex-claude-routing/01-codex-providers-require-routing.png)
...
![Claude ゲートウェイの Codex プロバイダーフォーム](/docs/assets/codex-claude-routing/02-claude-codex-provider-form.png)

Anthropic Messages を選ぶと、下に 3 つの関連フィールドが追加で表示されます：

![Anthropic 上流の高級オプション](/docs/assets/codex-claude-routing/03-anthropic-advanced-options.png)
...
![ローカルルーティング画面で Codex のルーティングを有効化](/docs/assets/codex-claude-routing/04-local-route-codex-takeover.png)
