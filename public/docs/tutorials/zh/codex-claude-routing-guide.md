...
![Codex 供应商列表里的需要路由标记](/docs/assets/codex-claude-routing/01-codex-providers-require-routing.png)
...
![Claude 网关的 Codex 供应商表单](/docs/assets/codex-claude-routing/02-claude-codex-provider-form.png)

选中 Anthropic Messages 后，下方会多出三个配套字段：

![Anthropic 上游的高级选项](/docs/assets/codex-claude-routing/03-anthropic-advanced-options.png)
...
![本地路由页面中启用 Codex 接管](/docs/assets/codex-claude-routing/04-local-route-codex-takeover.png)
