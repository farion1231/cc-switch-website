...
- [使用第三方 API 时保留 Codex 远程操作和官方插件：CC Switch 配置攻略](/zh/tutorials/codex-official-auth-preservation-guide)
- [在 Codex 中使用 DeepSeek 这类 Chat 格式 API：CC Switch 路由攻略](/zh/tutorials/codex-deepseek-routing-guide)
