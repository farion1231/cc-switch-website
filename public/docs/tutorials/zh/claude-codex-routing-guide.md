...
![Claude 供应商列表里 GPT 供应商的「需要路由」标记](/docs/assets/claude-codex-routing/01-claude-providers-require-routing.png)
...
![方式一：高级选项里把 API 格式设为 OpenAI Responses，认证字段保持默认，并映射到上游真实模型](/docs/assets/claude-codex-routing/02-responses-provider-form.png)
...
![方式二：Codex 预设的 ChatGPT 登录状态与账号管理](/docs/assets/claude-codex-routing/03-codex-oauth-form.png)
...
- [CC Switch 用户手册：添加供应商（含 Codex OAuth 反向代理与 API 格式）](/zh/docs?section=providers&item=add)
- [CC Switch 用户手册：代理服务](/zh/docs?section=proxy&item=service)
- [CC Switch 用户手册：应用路由](/zh/docs?section=proxy&item=routing)
- [CC Switch v3.17.0 发布说明](/zh/changelog/3.17.0)
- 反方向攻略：[在 Codex 中使用 Claude 模型](/zh/tutorials/codex-claude-routing-guide)
